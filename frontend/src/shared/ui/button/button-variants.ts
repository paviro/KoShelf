...
> = {
    primary: {
        ...
        hoverBg: 'hover:bg-primary-50 dark:hover:bg-primary-500/10',
        gradientBg:
            'bg-linear-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 shadow-lg shadow-primary-500/20',
    },
    secondary: {
        text: 'text-gray-500 dark:text-dark-400',
        border: 'border-gray-300/50 dark:border-dark-700/50',
        hoverBg: 'hover:bg-gray-100 dark:hover:bg-dark-700',
    },
    danger: {
    ...
    switch (variant) {
        ...
        case 'neutral':
            return active
                ...
                : 'bg-gray-100/50 dark:bg-dark-800/10 border border-gray-300/50 dark:border-dark-700/50 text-gray-900 dark:text-white hover:bg-gray-200/50 dark:hover:bg-dark-700/50 backdrop-blur-xs duration-200';
