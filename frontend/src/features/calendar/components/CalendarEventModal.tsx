                ...
                <div className="flex flex-col @[280px]:flex-row items-center @[280px]:items-start gap-4">
                    <div className="shrink-0">
                        {coverUrl && !coverFailed ? (
                            ...
                            <div className="w-20 aspect-square rounded-lg shadow-lg bg-linear-to-br from-primary-500/20 to-primary-600/20 border border-primary-500/30 flex items-center justify-center">
                                <HiOutlineBookOpen
                    ...
                    <div className="flex-1 min-w-0 @[280px]:pr-8 text-center @[280px]:text-left">
                        ...
                        <div className="flex items-center justify-center @[280px]:justify-start text-sm text-gray-500 dark:text-dark-300 mb-1">
                            <LuUser className="w-4 h-4 mr-2 text-primary-400 shrink-0" />
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="@container bg-green-50 dark:bg-dark-800/60 rounded-xl p-4 border border-green-200/70 dark:border-dark-700/50">
                        <div className="flex flex-col @[120px]:flex-row items-center justify-center @[120px]:justify-start @[120px]:items-center gap-2 @[120px]:gap-3 h-full">
                            <div className="w-8 h-8 bg-green-500/20 dark:bg-linear-to-br dark:from-green-500 dark:to-green-600 rounded-lg flex items-center justify-center shrink-0">
                    ...
                    <div className="@container bg-blue-50 dark:bg-dark-800/60 rounded-xl p-4 border border-blue-200/70 dark:border-dark-700/50">
                        <div className="flex flex-col @[120px]:flex-row items-center justify-center @[120px]:justify-start @[120px]:items-center gap-2 @[120px]:gap-3 h-full">
                            <div className="w-8 h-8 bg-blue-500/20 dark:bg-linear-to-br dark:from-blue-500 dark:to-blue-600 rounded-lg flex items-center justify-center shrink-0">
            ...
            {canViewDetails && (
                <div className="px-6 pb-6">
                    <div className="flex justify-center space-x-3">
                        <button
                            type="button"
                            className="px-6 py-3 bg-linear-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 focus:outline-hidden focus:ring-2 focus:ring-primary-500/50"
                            onClick={() => {
                                onClose();
                                if (detailPath) {
                                    navigate(detailPath, {
