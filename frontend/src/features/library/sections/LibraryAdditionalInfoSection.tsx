                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {identifiers.map((identifier) => {
                                ...
                                if (linkable) {
                                    return (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="group relative bg-gray-100 dark:bg-dark-800 border border-gray-300 dark:border-dark-700 rounded-lg p-4 hover:border-primary-500 dark:hover:border-primary-400 hover:bg-gray-200 dark:hover:bg-dark-700 transition-all duration-200 shadow-xs hover:shadow-md"
                                        >
                                ...
                                return (
                                    <div
                                        key={key}
                                        className="bg-gray-100 dark:bg-dark-800 border border-gray-300 dark:border-dark-700 rounded-lg p-4 shadow-xs"
                                    >
