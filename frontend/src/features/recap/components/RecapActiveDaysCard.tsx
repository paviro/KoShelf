...
export function RecapActiveDaysCard({
    ...
    return (
        <div
            className={`bg-linear-to-br from-teal-500/10 via-teal-400/5 to-transparent dark:from-teal-500/20 dark:via-teal-400/10 dark:to-dark-800 border border-teal-200/50 dark:border-teal-700/30 rounded-xl p-4 shadow-xs relative overflow-hidden group hover:shadow-lg hover:border-teal-300/70 dark:hover:border-teal-600/50 transition-all duration-300${className ? ` ${className}` : ''}`}
        >
