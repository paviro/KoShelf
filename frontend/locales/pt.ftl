...
theme-setting = Tema
theme-setting-description = Escolha como o KoShelf deve aparecer. Automático segue a preferência do seu sistema.
theme-option-auto = Automático
theme-option-light = Claro
theme-option-dark = Escuro
prefetch-setting = Pré-carregamento de links
prefetch-setting-description = Pré-carrega páginas ao passar o mouse, focar ou tocar em links para deixar a navegação mais rápida.
prefetch-option-enabled = Ativado
prefetch-option-disabled = Desativado
...
password-too-short = A palavra-passe deve ter pelo menos { $min } caracteres
...
session-device-info = { $browser } em { $os }
...
go-back =
    .aria-label = Voltar
open-reader-aria = Abrir no leitor
reader-title = Leitor
reader-loading = A carregar livro…
...
reader-font-size-decrease-aria = Diminuir tamanho da fonte
reader-font-size-increase-aria = Aumentar tamanho da fonte
reader-line-spacing = Espaçamento entre linhas
reader-line-spacing-decrease-aria = Diminuir espaçamento entre linhas
reader-line-spacing-increase-aria = Aumentar espaçamento entre linhas
reader-word-spacing = Espaçamento entre palavras
reader-word-spacing-decrease-aria = Diminuir espaçamento entre palavras
reader-word-spacing-increase-aria = Aumentar espaçamento entre palavras
...
reader-left-margin-decrease-aria = Diminuir margem esquerda
reader-left-margin-increase-aria = Aumentar margem esquerda
reader-right-margin = Margem direita
reader-right-margin-decrease-aria = Diminuir margem direita
reader-right-margin-increase-aria = Aumentar margem direita
reader-top-margin = Margem superior
reader-top-margin-decrease-aria = Diminuir margem superior
reader-top-margin-increase-aria = Aumentar margem superior
reader-bottom-margin = Margem inferior
reader-bottom-margin-decrease-aria = Diminuir margem inferior
reader-bottom-margin-increase-aria = Aumentar margem inferior
reader-mode-auto = Livro
reader-mode-on = Ativado
reader-mode-off = Desativado
reader-reset-book = Usar configurações do livro
reader-reset-book-aria = Restaurar para as configurações de exibição sincronizadas do livro
reader-reset-defaults = Restaurar padrões
reader-reset-defaults-aria = Restaurar as configurações de exibição do leitor para os padrões
reader-drawer-aria = Painel de navegação do livro
reader-no-toc = Nenhum sumário disponível
reader-no-toc-description = Este ficheiro não inclui marcadores de capítulo.
reader-no-highlights = Ainda não há destaques
reader-no-highlights-description = Os destaques que adicionar no KoReader aparecerão aqui.
reader-no-bookmarks = Ainda não há marcadores
reader-no-bookmarks-description = Os marcadores que adicionar no KoReader aparecerão aqui.
