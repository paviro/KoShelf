...
theme-setting = Тема
theme-setting-description = Виберіть вигляд KoShelf. Автоматично враховує системну тему.
theme-option-auto = Автоматично
theme-option-light = Світла
theme-option-dark = Темна
prefetch-setting = Попереднє завантаження посилань
prefetch-setting-description = Попередньо завантажуйте сторінки під час наведення, фокусу або торкання посилань, щоб навігація відчувалася швидшою.
prefetch-option-enabled = Увімкнено
prefetch-option-disabled = Вимкнено
prefetch-setting-connection-note = Примітка: попереднє завантаження все одно автоматично вимикається за обмеженого зʼєднання (наприклад, режим економії трафіку або повільніші мобільні мережі).
language-setting = Мова
region-setting = Регіон
language-setting-hint = Визначає мову для всіх перекладів інтерфейсу.
...
reader-settings-aria = Налаштування відображення
reader-section-typography = Типографіка
reader-section-margins = Відступи
reader-font-size = Розмір шрифту
reader-font-size-decrease-aria = Зменшити розмір шрифту
reader-font-size-increase-aria = Збільшити розмір шрифту
reader-line-spacing = Міжрядковий інтервал
reader-line-spacing-decrease-aria = Зменшити міжрядковий інтервал
reader-line-spacing-increase-aria = Збільшити міжрядковий інтервал
reader-word-spacing = Міжслівний інтервал
reader-word-spacing-decrease-aria = Зменшити міжслівний інтервал
reader-word-spacing-increase-aria = Збільшити міжслівний інтервал
...
reader-left-margin-decrease-aria = Зменшити лівий відступ
reader-left-margin-increase-aria = Збільшити лівий відступ
reader-right-margin = Правий відступ
reader-right-margin-decrease-aria = Зменшити правий відступ
reader-right-margin-increase-aria = Збільшити правий відступ
reader-top-margin = Верхній відступ
reader-top-margin-decrease-aria = Зменшити верхній відступ
reader-top-margin-increase-aria = Збільшити верхній відступ
reader-bottom-margin = Нижній відступ
reader-bottom-margin-decrease-aria = Зменшити нижній відступ
reader-bottom-margin-increase-aria = Збільшити нижній відступ
reader-mode-auto = Книга
reader-mode-on = Увімк.
reader-mode-off = Вимк.
reader-reset-book = Налаштування книги
reader-reset-book-aria = Повернути синхронізовані налаштування відображення книги
reader-reset-defaults = Скинути до типових
reader-reset-defaults-aria = Скинути налаштування відображення рідера до типових
