...
locale-setting-description = Оберіть мову та регіон для перекладів, а також форматування дати й чисел.
example = Приклад
...
error-state =
    ...
    .description = Не вдалося завантажити дані. Будь ласка, спробуйте ще раз.
    ...
    .connection-description = Не вдалося зв'язатися з сервером. Перевірте з'єднання та спробуйте знову.
