...
theme-setting = Thème
theme-setting-description = Choisissez l'apparence de KoShelf. Le mode automatique suit votre préférence système.
theme-option-auto = Automatique
theme-option-light = Clair
theme-option-dark = Sombre
prefetch-setting = Préchargement des liens
prefetch-setting-description = Préchargez des pages lorsque vous survolez, focalisez ou touchez des liens pour rendre la navigation plus rapide.
prefetch-option-enabled = Activé
prefetch-option-disabled = Désactivé
prefetch-setting-connection-note = Remarque : le préchargement est toujours ignoré automatiquement lorsque votre connexion est limitée (par exemple Économiseur de données ou réseaux mobiles plus lents).
language-setting = Langue
region-setting = Région
language-setting-hint = Définit la langue utilisée pour toutes les traductions de l'interface.
...
reader-settings-aria = Paramètres d'affichage
reader-section-text = Texte
reader-section-typography = Typographie
reader-section-margins = Marges
reader-font-size = Taille de police
reader-font-size-decrease-aria = Diminuer la taille de police
reader-font-size-increase-aria = Augmenter la taille de police
reader-line-spacing = Interligne
reader-line-spacing-decrease-aria = Diminuer l'interligne
reader-line-spacing-increase-aria = Augmenter l'interligne
reader-word-spacing = Espacement des mots
reader-word-spacing-decrease-aria = Diminuer l'espacement des mots
reader-word-spacing-increase-aria = Augmenter l'espacement des mots
...
reader-left-margin-decrease-aria = Réduire la marge gauche
reader-left-margin-increase-aria = Augmenter la marge gauche
reader-right-margin = Marge droite
reader-right-margin-decrease-aria = Réduire la marge droite
reader-right-margin-increase-aria = Augmenter la marge droite
reader-top-margin = Marge supérieure
reader-top-margin-decrease-aria = Réduire la marge supérieure
reader-top-margin-increase-aria = Augmenter la marge supérieure
reader-bottom-margin = Marge inférieure
reader-bottom-margin-decrease-aria = Réduire la marge inférieure
reader-bottom-margin-increase-aria = Augmenter la marge inférieure
reader-mode-auto = Livre
reader-mode-on = Activé
reader-mode-off = Désactivé
reader-reset-book = Utiliser les paramètres du livre
reader-reset-book-aria = Rétablir les paramètres d’affichage synchronisés du livre
reader-reset-defaults = Réinitialiser par défaut
reader-reset-defaults-aria = Réinitialiser les paramètres d’affichage du lecteur par défaut
...
reader-no-highlights-description = Les surlignages que vous ajoutez dans KoReader s'afficheront ici.
