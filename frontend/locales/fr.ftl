...
locale-setting-description = Choisissez la langue et la région pour les traductions ainsi que le format des dates et des nombres.
example = Exemple
...
error-state =
    ...
    .connection-description = Impossible de joindre le serveur. Vérifiez votre connexion et réessayez.
    .retry = Réessayer
